...
/**
 * Created by HJD on 2018/7/17 0017 and 20:32.
 * /-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/-/
...
public class NetUtils {
    ...
    public static void checkNetwork(final Activity activity) {
        if (!NetUtils.isNetworkAvalible(activity)) {
            ...
            msg.setGravity(View.TEXT_ALIGNMENT_GRAVITY);
            new AlertDialog.Builder(activity).setIcon(R.drawable.icon_no_internet).setTitle("网络状态提示").setView(msg).setPositiveButton("确定", new DialogInterface.OnClickListener() {
